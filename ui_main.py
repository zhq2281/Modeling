...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionOpenCv_add = QtWidgets.QAction(MainWindow)
        self.actionOpenCv_add.setObjectName("actionOpenCv_add")
        self.menu.addAction(self.actionopen)
        self.menu_2.addAction(self.actionplot_Lne)
        self.menu_2.addAction(self.actionOpenCV)
        self.menu_2.addAction(self.actionOpenCv_add)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionOpenCv_add.setText(_translate("MainWindow", "OpenCV-add"))
